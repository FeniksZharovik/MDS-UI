class Slider {
  constructor(_element) {
    ...
    this.items = [
      ...
      this.slider.querySelector(".item-4"),
      this.slider.querySelector(".item-5"),
      this.slider.querySelector(".item-6"),
    ];
  ...
  item_6Click = () => {
    ...
    this.items[5].removeEventListener("mousedown", this.item_6Click);
    this.next();
  };
  ...
  listeners = () => {
    this.items[5].addEventListener("mousedown", this.item_6Click);
  ...
  next = () => {
    this.items.unshift(this.items[5]);
    this.items.pop();
    this.reclass();
    this.listeners();
    this.setBackground();
